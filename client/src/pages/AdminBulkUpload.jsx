...
export default function AdminBulkUploads() {
    ...
    const handleUpload = async () => {
        ...
        try {
            // TODO: replace mock below with real fetch once backend is ready
            ...
            // mock response simulating a file with some errors
            await new Promise(r => setTimeout(r, 800));
            setResults({
                created: 3,
                updated: 1,
                errors: [
                    { line: 2, content: 'O||NewOrg', reason: 'O type not allowed for sponsor uploads' },
                    { line: 5, content: 'D||John|Smith|john@email.com|100|', reason: 'Points present but no reason provided' },
                ]
            });
        } catch (err) {
            console.error(err);
